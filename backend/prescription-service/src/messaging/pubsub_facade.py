"""PubSub facade for prescription-service — mirrors the appointment-service pattern."""
...
class PubSubFacade:
    ...
    def subscribe(
        ...
        Args:
            ...
            message_class: Message type for deserialisation.
