...
async def main():
    ...
    async with connection:
        ...
        email_event = {
            ...
            "message": "Hello! If you are reading this, the RabbitMQ message broker successfully routed the event to the email-service container, which then sent this real email.",
            "is_html": False
        }
        ...
        print(f"✅ Successfully published test message to RabbitMQ 'email_queue'!")
        print(f"Waiting for the email-service container to pick it up and email {settings.SMTP_FROM_EMAIL}...")
